...
export const brand: Brand = {
  name: "House of Glam",
  shortName: "HOG",
  microTag: "ACCRA'S HOUSE OF GLAM",
  description:
    "House of Glam in Accra is where nails get the time and detail they deserve — clean sets, careful prep and finishes that last.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0203547801",
    phoneTel: "+233203547801",
    textPhone: "0203547801",
    textPhoneTel: "+233203547801",
    email: "hello@hog.test",
    privacyEmail: "privacy@hog.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@houseofglam.gh", icon: "tiktok" },
  ],
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "House of Glam exists so that slowing down doesn't cost you your rhythm. One hour here gives back more than it takes — a genuine reset with a visible result.",
    ...
    images: [
      {
        ...
        alt: "House of Glam beauty treatment detail",
      ...
      },
      {
        ...
        alt: "House of Glam self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "House of Glam beauty ritual",
      ...
      },
      {
        ...
        alt: "House of Glam calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "House of Glam relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "House of Glam beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "House of Glam lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "House of Glam mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "House of Glam makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "House of Glam foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@houseofglam.gh",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783462181/stage4/spa_houseofglamgh/tiktok_0.mp4",
        alt: "House of Glam treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783462187/stage4/spa_houseofglamgh/tiktok_1.mp4",
        alt: "House of Glam treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783462189/stage4/spa_houseofglamgh/tiktok_2.mp4",
        alt: "House of Glam treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "House of Glam self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "House of Glam studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About House of Glam",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "House of Glam is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0203547801 and text 0203547801 for booking help.",
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0203547801, text 0203547801, or message @houseofglam.gh on Instagram." },
          ...
          { q: "Where are you located?", a: "House of Glam is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "House of Glam (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@hog.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "House of Glam is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@hog.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to House of Glam",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0203547801", href: "tel:+233203547801" },
      { label: "Text", value: "0203547801", href: "sms:+233203547801" },
      { label: "Instagram", value: "@houseofglam.gh", href: "https://www.tiktok.com/@houseofglam.gh" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783462175/stage4/spa_houseofglamgh/avatar.jpg",
    blurb:
      "House of Glam in Accra — accra's house of glam.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@houseofglam.gh" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0203547801", href: "tel:+233203547801" },
          { label: "Text 0203547801", href: "sms:+233203547801" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "House of Glam — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
