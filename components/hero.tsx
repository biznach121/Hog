...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#6a3500] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#793b00]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(69, 30, 0,0.58),rgba(96, 33, 0,0.22)_43%,rgba(71, 33, 0,0.34)),linear-gradient(0deg,rgba(37, 18, 0,0.18),rgba(37, 18, 0,0.08))]" />
