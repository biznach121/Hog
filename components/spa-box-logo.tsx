...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783462174/stage4/spa_houseofglamgh/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="House of Glam - Accra's house of glam">
        <Image
          src={src}
          alt="House of Glam - Accra's house of glam"
          fill
